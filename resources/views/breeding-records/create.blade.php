...
@section('title', 'Add Breeding Record - Dairy Farm Management')
@section('page-title', 'Add Breeding Record')
                    ...
                    <form method="POST" action="{{ route('breeding-records.store') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                @enderror
                                <div class="form-text">Only female animals are shown</div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('date_of_service', today()->format('Y-m-d')) }}" 
                                       required
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('breeding_method') is-invalid @enderror" 
                                    ...
                                    <option value="Natural" {{ old('breeding_method') == 'Natural' ? 'selected' : '' }}>Natural Service</option>
                                    <option value="AI" {{ old('breeding_method') == 'AI' ? 'selected' : '' }}>Artificial Insemination (AI)</option>
                                    <option value="Synchronization" {{ old('breeding_method') == 'Synchronization' ? 'selected' : '' }}>Synchronization Program</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="bull_semen_id" 
                                       name="bull_semen_id" 
                                       value="{{ old('bull_semen_id') }}"
                                       placeholder="e.g., BULL-001, SEMEN-ABC123">
                                @error('bull_semen_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">For AI: Semen straw ID</div>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('pregnancy_diagnosis_date') }}">
                                @error('pregnancy_diagnosis_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Typically 28-35 days after service</div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('pregnancy_result') is-invalid @enderror" 
                                    ...
                                    <option value="1" {{ old('pregnancy_result') == '1' ? 'selected' : '' }}>Pregnant</option>
                                    <option value="0" {{ old('pregnancy_result') == '0' ? 'selected' : '' }}>Not Pregnant</option>
                                </select>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('calving_outcome') is-invalid @enderror" 
                                    ...
                                    <option value="Live Calf" {{ old('calving_outcome') == 'Live Calf' ? 'selected' : '' }}>Live Calf</option>
                                    <option value="Stillborn" {{ old('calving_outcome') == 'Stillborn' ? 'selected' : '' }}>Stillborn</option>
                                    <option value="Twins" {{ old('calving_outcome') == 'Twins' ? 'selected' : '' }}>Twins</option>
                                    <option value="Abortion" {{ old('calving_outcome') == 'Abortion' ? 'selected' : '' }}>Abortion</option>
                                    <option value="Retained Placenta" {{ old('calving_outcome') == 'Retained Placenta' ? 'selected' : '' }}>Retained Placenta</option>
                                    <option value="Dystocia" {{ old('calving_outcome') == 'Dystocia' ? 'selected' : '' }}>Dystocia (Difficult Birth)</option>
                                </select>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" 
                                          ...
                                          name="notes" 
                                          rows="3"
                                          placeholder="Any observations, comments, or follow-up actions...">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="alert alert-info mb-4">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <span id="pregnancyTimeline">Enter date of service to see timeline</span>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (!dateOfServiceField.value) {
            dateOfServiceField.value = new Date().toISOString().split('T')[0];
